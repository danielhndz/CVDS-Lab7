...
public class MyBATISItemRentadoDAO implements ItemRentadoDAO {
    ...
    @Override
    public ItemRentado consultarItemRentado(int itemRentadoId) throws PersistenceException {
        try {
            return itemRentadoMapper.consultarItemRentado(itemRentadoId);
        } catch (PersistenceException e) {
            throw new PersistenceException("Error al consultar el ítem rentado " + itemRentadoId + ".", e);
        }
    }
